# Taken directly from https://gist.github.com/inkedmn/5041037 written by Brett Kelly
# Used to generate my auth token for evernote, which I only need to do once (per year..)
